...
namespace DossylEditor.GameProject {
    ...
    class OpenProject {
        private static readonly string _applicationDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\DossylEditor\";
            ...
            if (File.Exists(_projectDataPath)) {
                ...
                foreach (var project in projects){
                    if (File.Exists(project.FullPath)) {
                        project.Icon = File.ReadAllBytes($@"{project.ProjectPath}\.Dossyl\Icon.png");
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}\.Dossyl\Screenshot.png");
        ...
        public static Project Open(ProjectData projectData) {
            ...
            else { // new project to add to list
                project = projectData;
                project.Date = DateTime.Now;
                _projects.Add(project);
            }
